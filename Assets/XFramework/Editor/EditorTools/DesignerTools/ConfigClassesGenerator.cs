...
{
    private const string DEFAULT_JSON_DIR = "Assets/Tables/Schemes";
    private const string DEFAULT_OUTPUT_DIR = "Assets/Tables/Classes";
    private const string DEFAULT_NAMESPACE = "GamePlay.Table";
    ...
    private string GenerateClassCode(string className, JObject jsonObj)
    {
        ...
        sb.AppendLine("/// Auto-generated file, don't modify it manually.");
        sb.AppendLine("/// </auto-generated>");
        sb.AppendLine("/// ------------------------------------------------------------------------------");
        sb.AppendLine();
        ...
        sb.AppendLine($"    public class {className}Item");
        sb.AppendLine("    {");
