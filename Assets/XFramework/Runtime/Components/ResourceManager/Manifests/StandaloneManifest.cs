...
namespace XFramework
{
    ...
    /// 单机模式下的资源清单
    /// </summary>
    public readonly struct StandaloneManifest
    {
        ...
        public StandaloneManifest(string resourceVersion, ManifestAsset[] assets, ManifestFileSystem[] fileSystems, ManifestResource[] resources, ManifeestResourceGroup[] resourceGroups)
        {
            _isValid = true;
