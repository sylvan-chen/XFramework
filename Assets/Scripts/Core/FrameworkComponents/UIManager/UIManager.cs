...
namespace XGame.Core
{
    ...
    public sealed class UIManager : FrameworkComponent
    {
        ...
        // {
        //     if (_setting.UICamera != null)
        //     {
        //         _uiCamera = _setting.UICamera;
        //         return;
        //     }
        ...
        // {
        //     var layerTable = Game.TableManager.GetTable<TableUiLayers>();
        //     // foreach (var config in layerTable.Configs)
        //     // {
        //     //     // 检查是否已经存在该层级
        ...
        //     var panelConfig = Game.TableManager.GetTable<TableUiPanel>().GetConfigById(id);

        //     var assetHandler = await Game.AssetManager.LoadAssetAsync<GameObject>(panelConfig.Address);
        ...
        //     _loadedPanels[panelConfig.Id] = panel;
        //     return panel;
        // }
