...
namespace XFramework
{
    ...
    public static class XFrameworkCore
    {
        ...
        public static T GetSystem<T>() where T : class, IManager
        {
        ...
        /// <returns>系统实例</returns>
        private static BaseManager AcquireSystem(Type type)
        {
            foreach (BaseManager system in _systems)
            {
        ...
        private static BaseManager RegisterSystem(Type systemType)
        {
